...
@Component({
    selector: 'app-menu6932',
    templateUrl: './menu6932.component.html',
    // styleUrls: ['./menu6932.component.scss'],
    animations: [
...
export class Menu6932Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
