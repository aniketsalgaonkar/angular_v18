...
@Component({
    selector: 'app-menu6939',
    templateUrl: './menu6939.component.html',
    // styleUrls: ['./menu6939.component.scss'],
    animations: [
...
export class Menu6939Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
