...
@Component({
    selector: 'app-menu6926',
    templateUrl: './menu6926.component.html',
    // styleUrls: ['./menu6926.component.scss'],
    animations: [
...
export class Menu6926Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
    ...
    onSubmit(form: any, ID: any, LinkedMenu: any, moduleIndex): void {
        ...
        this.saveForm(ID, moduleIndex, form, LinkedMenu, appId, filter1,formRef);
    }

    async saveForm(ID, moduleIndex, form, LinkedMenu, appId, filter1,formRef ? : any) {
