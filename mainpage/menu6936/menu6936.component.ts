...
@Component({
    selector: 'app-menu6936',
    templateUrl: './menu6936.component.html',
    // styleUrls: ['./menu6936.component.scss'],
    animations: [
...
export class Menu6936Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
