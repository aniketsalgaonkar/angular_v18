...
@Component({
    selector: 'app-menu6940',
    templateUrl: './menu6940.component.html',
    // styleUrls: ['./menu6940.component.scss'],
    animations: [
...
export class Menu6940Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
