...
@Component({
    selector: 'app-menu1204',
    templateUrl: './menu1204.component.html',
    // styleUrls: ['./menu1204.component.scss'],
    animations: [
...
export class Menu1204Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
