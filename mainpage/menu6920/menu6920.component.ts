...
@Component({
    selector: 'app-menu6920',
    templateUrl: './menu6920.component.html',
    styleUrls: ['./menu6920.component.scss'],
    animations: [
...
export class Menu6920Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
