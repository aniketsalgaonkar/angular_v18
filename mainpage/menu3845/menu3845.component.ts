...
@Component({
    selector: 'app-menu3845',
    templateUrl: './menu3845.component.html',
    // styleUrls: ['./menu3845.component.scss'],
    animations: [
...
export class Menu3845Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
