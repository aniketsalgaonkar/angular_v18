...
@Component({
    selector: 'app-menu6924',
    templateUrl: './menu6924.component.html',
    styleUrls: ['./menu6924.component.scss'],
    animations: [
...
export class Menu6924Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
