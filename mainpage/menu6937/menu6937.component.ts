...
@Component({
    selector: 'app-menu6937',
    templateUrl: './menu6937.component.html',
    // styleUrls: ['./menu6937.component.scss'],
    animations: [
...
export class Menu6937Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
