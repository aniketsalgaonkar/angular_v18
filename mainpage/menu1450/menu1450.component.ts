...
@Component({
  selector: 'app-menu1450',
  templateUrl: './menu1450.component.html',
  styleUrl: './menu1450.component.scss',
  encapsulation: ViewEncapsulation.None,
})
export class Menu1450Component {
  ...
  finalSubmitConfirmation(i: any, Event: any) {
    ...
    if (Event == 'Submit') {
      this.confirmationService.confirm({
        ...
        acceptButtonProps: {
          styleClass: 'custom-accept-btn',
         
        },
        rejectButtonProps: {
          styleClass: 'custom-reject-btn',
          outlined: true
        },
