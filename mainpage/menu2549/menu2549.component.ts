...
@Component({
    selector: 'app-menu2549',
    templateUrl: './menu2549.component.html',
    styleUrls: ['./menu2549.component.scss'],
    animations: [
...
export class Menu2549Page implements OnInit, ComponentCanDeactivate, AfterViewChecked {
