import { Component, OnInit, ViewChild, ViewChildren, AfterViewChecked, QueryList, ElementRef, HostListener, Injectable } from '@angular/core';
...
export class DataviewDisplay implements OnInit {
  ...
  async Run(i: any) {
    ...
    this.mainPageService.RunWorkflowTask(i, this.UserName, undefined).subscribe({
      next: async (resp: any) => {
