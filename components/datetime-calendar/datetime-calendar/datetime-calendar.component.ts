...
export const DATETIME_CALENDAR_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => DateTimeCalendarComponent),
  multi: true
};
...
@Component({
  ...
  providers: [DATETIME_CALENDAR_CONTROL_VALUE_ACCESSOR],
})
export class DateTimeCalendarComponent implements ControlValueAccessor, OnInit {
  date1: FormControl;
