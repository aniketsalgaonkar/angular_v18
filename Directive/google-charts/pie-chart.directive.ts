...
ngOnChanges(changes: SimpleChanges){
    if (changes['chartData'] && this.chartData) {
        setTimeout(() => {
            // //GoogleCharts.load("visualization", "1.1", { packages: ["corechart"] })
            // GoogleCharts.load('visualization', '1.1', { packages: ['pie', 'corechart'] });
            // GoogleCharts.setOnLoadCallback(this.drawChart(this.appPieChartConfig.ChartConfiguration,
            //     this.chartData));
            ...
            GoogleCharts.load('current', {
                ...
                this.drawChart(this.appPieChartConfig.ChartConfiguration, this.chartData);
                }
            });
        }, 100);
    }
